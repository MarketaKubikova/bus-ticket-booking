...
import com.example.busticketbooking.model.entity.*;
...
class ReservationServiceTest {
    ...
    void createReservation_validRequest_reservationCreated() {
        ReservationRequestDto request = new ReservationRequestDto(1L, 1, "test@test.com");
        ...
        ReservationResponseDto response = new ReservationResponseDto("Prague", "Vienna", departureDateTime, 1, "test@test.com");
        ...
        ReservationResponseDto result = service.createReservation(request);
        ...
        verify(reservationMapper, times(1)).toEntity(any(ReservationRequestDto.class));
    ...
    void createReservation_scheduledTripDoesNotExist_shouldThrowException() {
        ReservationRequestDto request = new ReservationRequestDto(99L, 1, "test@test.com");
    ...
    void createReservation_seatNotAvailable_shouldThrowException() {
        ReservationRequestDto request = new ReservationRequestDto(1L, 99, "test@test.com");
        Bus bus = new Bus("99", 5);
        LocalDateTime departureDateTime = LocalDateTime.of(2025, 1, 1, 11, 0, 0);
        ScheduledTrip scheduledTrip = new ScheduledTrip(1L, new Route(1L, new City(1L, "Prague"), new City(2L, "Vienna")), bus, departureDateTime);
